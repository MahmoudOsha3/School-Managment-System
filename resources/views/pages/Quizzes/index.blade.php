                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="datatable" class="table table-striped table-bordered p-0">
                            ...
                            <tbody>
                                @php $i = 1 @endphp
                                @foreach ($data['quizzes'] as $quizze)
                                    <tr>
                                        <td>{{ $i++ }}</td>
                                        <td>{{ $quizze->title }}</td>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#edit{{$quizze->id}}">
                                                <i class="fa fa-edit"></i>
                                            </button>

                                            <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#delete{{$quizze->id}}">
