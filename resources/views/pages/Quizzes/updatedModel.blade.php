    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- add_form -->
                <form action="{{ route('quizzes.update' , $quizze->id ) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="form-group">
                                ...
                                <select name="teachers_id" id="grade" class="form-control">
                                    ...
                                    @foreach ($data['teachers'] as $teacher)
                                        <option value="{{ $teacher->id }}" @selected($teacher->id == $quizze->teacher->id )>{{ $teacher->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="subject_id" id="subject_id" class="form-control">
                                @foreach ($data['subjects'] as $subject)
                                    <option value="{{ $subject->id }}" @selected($subject->id == $quizze->subject->id )>{{ $subject->name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
