...
@endsection
@section('page-header')
    <h3>{{trans('student.edit_student')}}</h3>
    <br>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select mr-sm-2" name="gender_id">
                                        ...
                                        @foreach($data['genders'] as $gender)
                                            <option  value="{{ $gender->id }}" @selected($gender->id == $student->gender->id)>{{ $gender->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select mr-sm-2" name="nationalitie_id">
                                        ...
                                        @foreach($data['nationalities']  as $nationaity)
                                            <option  value="{{ $nationaity->id }}" @selected($nationaity->id == $student->nationaity->id)>{{ $nationaity->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select mr-sm-2" name="blood_id">
                                        ...
                                        @foreach($data['blood'] as $blood_type)
                                            <option value="{{ $blood_type->id }}" @selected($blood_type->id == $student->blood->id)>{{ $blood_type->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select mr-sm-2" name="grade_id">
                                        ...
                                        @foreach($data['grades'] as $grade)
                                            <option  value="{{ $grade->id }}" @selected($grade->id == $student->grade->id) >{{ $grade->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select class="custom-select mr-sm-2" name="section_id">
                                        <option value="{{ $student->section->id }}">{{ $student->section->name }}</option>
                                        {{-- fill using ajax --}}
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select mr-sm-2" name="parent_id">
                                        ...
                                        @foreach($data['parent'] as $parent)
                                            <option value="{{ $parent->id }}" @selected($parent->id == $student->Myparent->id) >{{ $parent->Name_Father }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
