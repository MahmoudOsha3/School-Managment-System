            ...
            <ul class="nav navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown mr-30">
                    <a class="nav-link nav-pill user-avatar" data-toggle="dropdown" href="#" role="button"
                        ...
                        <img src="{{asset('assets/images/IMG_3870.jpg')}}" alt="avatar">
                    </a>
                                        ...
                                        <form method="GET" action="{{ route('logout','parent') }}">
                                            @else
                                                <form method="GET" action="{{ route('logout','web') }}">
                                                    ...
                                                    @csrf
                                                    <a class="dropdown-item" href="#" onclick="event.preventDefault();this.closest('form').submit();"><i class="text-danger ti-unlock"></i>{{ trans('site.logout') }}</a>
                                                </form>
                    </div>
                </li>
            </ul>
