<button class="btn btn-success btn-sm btn-lg pull-right" wire:click="showForm" type="button">{{ trans('parent.add_parent') }}</button><br><br>
        ...
        @foreach ($My_Parents as $my_parent)
            <tr>
                ...
                <td>
                    ...
                    <button type="button" class="btn btn-danger btn-sm" wire:click="destroy({{ $my_parent->id }})" title="{{ trans('Grades_trans.Delete') }}"><i class="fa fa-trash"></i></button>
                </td>
            </tr>
        @endforeach
    </table>
