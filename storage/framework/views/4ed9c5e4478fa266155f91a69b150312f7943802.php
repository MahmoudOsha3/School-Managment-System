...
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0"> <?php echo e(trans('site.grades')); ?></h4><br>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                <li class="breadcrumb-item"><a href="#" class="default-color"><?php echo e(trans('site.dashboard')); ?></a></li>
                <li class="breadcrumb-item active"><?php echo e(trans('site.grades')); ?></li>
            </ol>
        </div>
            ...
            <div class="card card-statistics h-100">
                ...
                <div class="card-body">
                    <button style="font-size:18px ;font-weight:bold" type="button" class="button x-small" data-toggle="modal" data-target="#exampleModal">
                        <?php echo e(trans('site.add_grade')); ?>
                        ...
                        <table id="datatable" class="table table-striped table-bordered p-0">
                            <thead>
                                <tr>
                                    ...
                                    <th><?php echo e(trans('site.notes')); ?></th>
                            ...
                            <tbody>
                                ...
                                <?php $__currentLoopData = $grades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $grade): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <button style="font-size:18px ;font-weight:bold" type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#edit<?php echo e($grade->id); ?>">
                                                <?php echo e(trans('site.edit')); ?>

                                            </button>

                                            <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#delete<?php echo e($grade->id); ?>">
                                        ...
                                        <!-- edit_modal_Grade -->
                                        <div class="modal fade" id="edit<?php echo e($grade->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 style="font-size:18px ;font-weight:bold" class="modal-title" id="exampleModalLabel">
                                                            <?php echo e(trans('site.edit_grade')); ?>
                                                            ...
                                                            <div class="row">
                                                                <div class="col">
                                                                    <label style="font-size:18px ;font-weight:bold" for="name_ar" class="mr-sm-2"><?php echo e(trans('site.ar.name')); ?>
                                                                        ...
                                                                        :</label>
                                                                    <input id="name_ar" type="text" name="name_ar" value="<?php echo e($grade->getTranslation('name', 'ar')); ?>" class="form-control">
                                                                </div>
                                                                <div class="col">
                                                                    <label style="font-size:18px ;font-weight:bold" for="Name_en" class="mr-sm-2"><?php echo e(trans('site.en.name')); ?>

                                                                        :</label>
                                                                    <input type="text" class="form-control" name="name_en" value="<?php echo e($grade->getTranslation('name', 'en')); ?>">
                                                                </div>
                                                            </div>
                                        ...
                                        <!-- delete_model -->
                                        <div class="modal fade" id="delete<?php echo e($grade->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                <h4 class="modal-title" id="exampleModalLongTitle"><?php echo e(trans('site.warning_delete_grade')); ?></h4>
                                                ...
                                                <div class="modal-body">
                                                    <form action="<?php echo e(route('grade.destroy' , $grade->id)); ?>" method="post">
                                                        ...
                                                        <input type="text" name="name" value="<?php echo e($grade->getTranslation('name' , App::getLocale() )); ?>" class="form-control" disabled>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects Laravel\projects\School Management System\resources\views/pages/grades/index.blade.php ENDPATH**/ ?>