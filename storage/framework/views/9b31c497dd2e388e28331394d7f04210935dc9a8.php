                                            ...
                                            <td>
                                                ...
                                                <label class="block text-gray-500 font-semibold sm:border-r sm:pr-4">
                                                    <input name="attendences[<?php echo e($student->id); ?>]" class="leading-tight" type="radio"
                                                        <?php $__currentLoopData = $student->attendance()->where('date_attednace' , date('Y-m-d'))->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attendance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php echo e($attendance->attednace_status == 1 ? 'checked' : ''); ?>
                                                ...
                                                <label class="ml-4 block text-gray-500 font-semibold">
                                                    <input name="attendences[<?php echo e($student->id); ?>]" class="leading-tight" type="radio"
                                                    <?php $__currentLoopData = $student->attendance()->where('date_attednace' , date('Y-m-d'))->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attendance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php echo e($attendance->attednace_status == 0 ? 'checked' : ''); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects Laravel\projects\School Management System\resources\views/pages/Teachers/dashboard/attendance/listStudentwithinSections.blade.php ENDPATH**/ ?>