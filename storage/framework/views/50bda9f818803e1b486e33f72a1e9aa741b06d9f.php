    ...
    <div class="col-md-12 mb-30">
        ...
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <form method="post" action="<?php echo e(route('onlineclass.store')); ?>" autocomplete="off">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                        <div class="col-md-4">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects Laravel\projects\School Management System\resources\views/pages/Teachers/dashboard/OnlineClasses/create.blade.php ENDPATH**/ ?>