    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- add_form -->
                <form action="<?php echo e(route('quizzes.update' , $quizze->id )); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                            ...
                            <div class="form-group">
                                ...
                                <select name="teachers_id" id="grade" class="form-control">
                                    ...
                                    <?php $__currentLoopData = $data['teachers']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teacher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($teacher->id); ?>" <?php if($teacher->id == $quizze->teacher->id ): echo 'selected'; endif; ?>><?php echo e($teacher->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="subject_id" id="subject_id" class="form-control">
                                <?php $__currentLoopData = $data['subjects']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($subject->id); ?>" <?php if($subject->id == $quizze->subject->id ): echo 'selected'; endif; ?>><?php echo e($subject->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>
...
<?php /**PATH D:\Projects Laravel\projects\School Management System\resources\views/pages/Quizzes/updatedModel.blade.php ENDPATH**/ ?>