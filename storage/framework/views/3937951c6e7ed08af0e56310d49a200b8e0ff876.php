...
<div class="page-title">
    <div class="row">
        ...
        <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('SectionLivewire')->html();
} elseif ($_instance->childHasBeenRendered('2nLOdKW')) {
    $componentId = $_instance->getRenderedChildComponentId('2nLOdKW');
    $componentTag = $_instance->getRenderedChildComponentTagName('2nLOdKW');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('2nLOdKW');
} else {
    $response = \Livewire\Livewire::mount('SectionLivewire');
    $html = $response->html();
    $_instance->logRenderedChild('2nLOdKW', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        <!-- add_modal_section -->
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects Laravel\School Management System\resources\views/livewire/section-livewire.blade.php ENDPATH**/ ?>