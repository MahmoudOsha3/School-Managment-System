...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0"> <?php echo e(trans('student.create_graduate')); ?></h4><br>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                <li class="breadcrumb-item"><a href="#" class="default-color"><?php echo e(trans('site.dashboard')); ?></a></li>
                <li class="breadcrumb-item active"><?php echo e(trans('student.create_graduate')); ?></li>
            </ol>
        </div>
                ...
                <div class="card-body">
                    <?php if(Session::has('error_promotions')): ?>
                        <div class="alert alert-danger alert-dismissible fade show" role="alert">
                            <strong><?php echo e(Session::get('error_graduate')); ?></strong>
                    ...
                    <form method="post" action="<?php echo e(route('graduates.store')); ?>" >
                        <?php echo csrf_field(); ?>
                        <div class="form-row">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects Laravel\projects\School Management System\resources\views/pages/Students/graduates/addNewGraduateStudent.blade.php ENDPATH**/ ?>