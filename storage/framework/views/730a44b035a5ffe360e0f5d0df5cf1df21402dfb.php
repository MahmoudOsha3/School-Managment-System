...
<head>
    ...
    <title><?php echo e(trans('site.school_title_page')); ?></title>
                ...
                <div class="row justify-content-center no-gutters vertical-align">
                    ...
                    <div style="border-radius: 15px;" class="col-lg-8 col-md-8 bg-white">
                        <div class="login-fancy pb-40 clearfix">
                            <h3 style="font-family: 'Cairo', sans-serif" class="mb-30"><?php echo e(trans('site.detemine_login')); ?></h3>
                            <div class="form-inline">
                                ...
                                <a class="btn btn-default col-lg-3" title="ولي امر" href="<?php echo e(route('login.show','parent')); ?>">
                                    <img alt="user-img" width="100px;" src="<?php echo e(URL::asset('assets/images/parent.png')); ?>">
                                </a>
                                <a class="btn btn-default col-lg-3" title="معلم" href="<?php echo e(route('login.show','teacher')); ?>">
                                    <img alt="user-img" width="100px;" src="<?php echo e(URL::asset('assets/images/teacher.png')); ?>">
                                </a>
...
<?php /**PATH D:\Projects Laravel\projects\School Management System\resources\views/auth/selection.blade.php ENDPATH**/ ?>