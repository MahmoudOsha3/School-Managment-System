 ...
 header start-->
        <nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            ...
            <div class="text-left navbar-brand-wrapper">
                <a class="navbar-brand brand-logo" href="index.html"><img src="<?php echo e(asset('assets/images/logo-dark.png')); ?>" alt=""></a>
            ...
            <ul class="nav navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown mr-30">
                    <a class="nav-link nav-pill user-avatar" data-toggle="dropdown" href="#" role="button"
                        ...
                        <img src="<?php echo e(asset('assets/images/IMG_3870.jpg')); ?>" alt="avatar">
                    </a>
        ...
        <!--=================================
 header End-->
<?php /**PATH D:\Projects Laravel\School Management System\resources\views/layouts/main-header.blade.php ENDPATH**/ ?>