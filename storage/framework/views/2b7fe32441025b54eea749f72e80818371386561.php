        ...
        <div class="col-xl-12 mb-30">
            <div class="card card-statistics h-100">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="<?php echo e(route('teacher.view.attendance.reports')); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col">
                                ...
                                <select class="custom-select mr-sm-2" name="student_id" required>
                                    ...
                                    <option value="0"><?php echo e(trans('student.all_student')); ?></option>
                                    <?php $__currentLoopData = $list_all_student; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects Laravel\projects\School Management System\resources\views/pages/Teachers/dashboard/attendance/reports.blade.php ENDPATH**/ ?>