...
<div class="modal fade" id="edit<?php echo e($exam->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 style="font-size:18px ;font-weight:bold" class="modal-title" id="exampleModalLabel">
                    <?php echo e(trans('student.edit_exam')); ?>
                    ...
                    <div class="row">
                        <div class="col">
                            <label style="font-size:18px ;font-weight:bold" for="name"
                                ...
                                :</label>
                            <input id="name" type="text" name="title_ar" value="<?php echo e($exam->getTranslation('title','ar')); ?>" class="form-control">
                        </div>
                        <div class="col">
                            <label style="font-size:18px ;font-weight:bold" for="Name_en"
                                ...
                                :</label>
                            <input type="text" class="form-control" name="title_en"  value="<?php echo e($exam->getTranslation('title','en')); ?>">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <label style="font-size:18px ;font-weight:bold" for="name"
                                ...
                                :</label>
                            <input id="name" type="text" name="term" class="form-control"  value="<?php echo e($exam->term); ?>">
                        </div>
                        <div class="col">
                            <div class="form-group">
                                <label for="academic_year"><?php echo e(trans('student.academic_year')); ?> : <span
...
<?php /**PATH D:\Projects Laravel\projects\School Management System\resources\views/pages/Exams/updatedModel.blade.php ENDPATH**/ ?>