            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    <div class="col-xl-12 mb-30">
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                <a href="<?php echo e(route('libraries.create')); ?>" class="btn btn-success btn-sm" role="button" aria-pressed="true"><?php echo e(trans('student.add_book')); ?></a><br><br>
                                        ...
                                        <tbody>
                                            ...
                                            <?php $__currentLoopData = $books; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo e(route('taecher.download.book' , $book->id )); ?>" title="<?php echo e(trans('student.download')); ?>" type="button" class="btn btn-success btn-sm">
                                                            <i class="fa fa-download"></i>
                                                        </a>

                                                        <a href="<?php echo e(route('libraries.edit' , $book->id )); ?>" type="button" class="btn btn-primary btn-sm">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects Laravel\projects\School Management System\resources\views/pages/Teachers/dashboard/library/index.blade.php ENDPATH**/ ?>