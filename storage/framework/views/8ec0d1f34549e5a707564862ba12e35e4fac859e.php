...
<?php $__env->startSection('title'); ?>
    <?php echo e(trans('student.add_student')); ?>

<?php $__env->stopSection(); ?>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('page-header'); ?>
    <h3><?php echo e(trans('student.add_student')); ?></h3>
    <br>
            ...
            <div class="card-body">
                ...
                <form method="post"  action="<?php echo e(route('students.store')); ?>" autocomplete="off" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select mr-sm-2" name="nationalitie_id">
                                        ...
                                        <?php $__currentLoopData = $data['nationalities']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nationaity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option  value="<?php echo e($nationaity->id); ?>"><?php echo e($nationaity->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select mr-sm-2" name="blood_id">
                                        ...
                                        <?php $__currentLoopData = $data['blood']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blood_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($blood_type->id); ?>"><?php echo e($blood_type->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select class="custom-select mr-sm-2" name="classroom_id">
                                        <option value="" selected disabled><?php echo e(trans('student.Choose')); ?>...</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select mr-sm-2" name="parent_id">
                                        ...
                                        <?php $__currentLoopData = $data['parent']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $parent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($parent->id); ?>"><?php echo e($parent->Name_Father); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="images"><?php echo e(trans('site.images')); ?> : <span class="text-danger">*</span></label>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects Laravel\projects\School Management System\resources\views/pages/Students/create.blade.php ENDPATH**/ ?>