                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="datatable" class="table table-striped table-bordered p-0">
                            ...
                            <tbody>
                                <?php $i = 1 ?>
                                <?php $__currentLoopData = $data['quizzes']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $quizze): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($i++); ?></td>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#edit<?php echo e($quizze->id); ?>">
                                                <i class="fa fa-edit"></i>
                                            </button>

                                            <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#delete<?php echo e($quizze->id); ?>">
                                        ...
                                        <?php echo $__env->make('pages.Quizzes.updatedModel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        <!-- delete_model -->
...
<!-- breadcrumb -->
<?php echo $__env->make('pages.Quizzes.addedModel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects Laravel\projects\School Management System\resources\views/pages/Quizzes/index.blade.php ENDPATH**/ ?>