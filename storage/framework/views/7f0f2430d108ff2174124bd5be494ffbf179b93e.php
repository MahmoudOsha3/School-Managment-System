                ...
                <div class="col-lg-4">
                    <div class="card mb-4">
                        <div class="card-body text-center">
                            ...
                            <h5 style="font-family: Cairo" class="my-3"><?php echo e($teacher->name); ?></h5>
                            <p class="text-muted mb-1"><?php echo e($teacher->email); ?></p>
                            <p class="text-muted mb-4"><?php echo e(trans('site.teacher')); ?></p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-8">
                    <div class="card mb-4">
                        <div class="card-body">
                            <form action="<?php echo e(route('teacher.profile.update')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <div class="row">
                                    <div class="col-sm-3">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects Laravel\projects\School Management System\resources\views/pages/Teachers/dashboard/profile/index.blade.php ENDPATH**/ ?>