 ...
 header start-->
                                        ...
                                        <form method="GET" action="<?php echo e(route('logout','parent')); ?>">
                                            <?php else: ?>
                                                <form method="GET" action="<?php echo e(route('logout','web')); ?>">
                                                    ...
                                                    <?php echo csrf_field(); ?>
                                                    <a class="dropdown-item" href="#" onclick="event.preventDefault();this.closest('form').submit();"><i class="text-danger ti-unlock"></i><?php echo e(trans('site.logout')); ?></a>
                                                </form>
                    </div>
                </li>
            </ul>
        ...
        <!--=================================
 header End-->
<?php /**PATH D:\Projects Laravel\projects\School Management System\resources\views/layouts/main-header.blade.php ENDPATH**/ ?>