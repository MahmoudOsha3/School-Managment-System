...
class OnlineClassesController extends Controller
{
    ...
    {
        $onlineClasses = OnlineClasses::where('created_by' , auth()->user()->email )->get() ;
        return view('pages.Teachers.dashboard.OnlineClasses.index' , compact('onlineClasses')) ;
    }
    ...
    public function create()
    {
        ...
        return view('pages.Teachers.dashboard.OnlineClasses.create' , compact('grades')) ;
    }
    ...
    public function store(Request $request)
    {
        try
        {
            ...
            return redirect()->route('onlineclass.index')->with(['success' => trans('site.added')]) ;
        }
        catch (\Exception $e)
        {
